<html>
<head>
	<title>EDESA MEDICARE BUNGOMA</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">
      ...
      <a class="navbar-brand js-scroll-trigger" href="#" style="margin-top: 10px;  color: white; margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp </h4></a>EDESA MEDICARE BUNGOMA
...
<div class="container register" style="font-family: 'IBM Plex Sans', sans-serif;">
                <div class="row">
                    ...
                    <img src="director/p4.jpg" alt="" style="width: 150%;padding-left: 40px;margin-top: 100px;margin-left: 0px;margin-bottom:0px">
                        <h3>Welcome</h3>
